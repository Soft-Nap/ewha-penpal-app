...
const Friends = ({onPress}) => {
    return (
        <FriendFrame>
            {/*프로필 부분 틀*/}
            <Image style={{width: 115, height: 115, backgroundColor: colors.green,
                                borderWidth: 1, borderColor: colors.black, borderRadius: 60,
                                position: 'absolute',top: -57 ,zIndex: -1, }}/>
            <Image style={{width: 115, height: 115, backgroundColor: colors.green,
            ...
            source = {Images.Pig.uri}/>
                <TouchableOpacity onPress={() => onPress()}activeOpacity = {0.8} >
                    <Friend>
                        ...
                        <TagArea><Tag text="태그 1"/><Tag text="태그 2"/><Tag text="태그 3"/></TagArea>
                    </Friend>
                </TouchableOpacity> 
            </FriendFrame>
    );
      ...
      <TouchableOpacity onPress={() => onPress()} activeOpacity = {0.5}>
        <View
          ...
          borderWidth: 1,
            ...
            <Image source = {Images.MailIcon.uri} style = {{width: 30, height: 30, resizeMode: 'contain'}}/>
        </View>
      </TouchableOpacity>
    );
  };
